        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                setTimeout(() => {
                    ...
                    successMessage.style.cssText = 'background: #d4edda; color: #155724; padding: 1rem; border-radius: 0.25rem; margin-top: 1rem; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a4b37207-ddfe-4d12-b855-6eb7d4edd49f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a4b37207-ddfe-4d12-b855-6eb7d4edd49f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a4b37207-ddfe-4d12-b855-6eb7d4edd49f';
